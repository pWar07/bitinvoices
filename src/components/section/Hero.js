...
import heroImg from "../../assets/images/ethereum-removebg.png"

const Hero = () => {
  return (
    <section id="home" className="hero h-[84vh] w-[100%] flex relative text-zinc-900 ">
      ...
      <div className="hero-img w-[40%]">
        <img className="h-5/6 mx-auto rotate-12 object-center" src={heroImg} alt="" />
      </div>
    </section>
  );
};
